    ...
    return (
        ...
        <Box flex={2} padding={2} sx={{display:{xs: "none", sm:"block"}}}>
            ...
            <Box position="fixed" width={300}>
                ...
                {/*Componente muy interesante para mostrar una lista de contactos*/}
                <AvatarGroup wid max={7}>
                    <Avatar
                        alt="Remy Sharp"
                ...
                {/*Para agregar una lista de imagenes utilizaremos este componente y aqui mismo le podemos
                indicar la separacion de imagenes aqui seran 3 columnas 1 para cada imagen y el tamaño de la fila*/}
                ...
                <Typography variant="h6" fontWeight={100} marginTop={2} marginBottom={2}>Latest Conversations</Typography>
